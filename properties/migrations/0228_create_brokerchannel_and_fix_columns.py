...
def add_critical_missing_columns_and_tables(apps, schema_editor):
    ...
    with connection.cursor() as cursor:
        # Add missing columns to properties_property
        property_columns = [
        ...
        # Add critical missing columns to properties_sitesettings
        settings_columns = [
        ...
        for col_name, col_type, default_val in settings_columns:
            cursor.execute("""
                SELECT EXISTS (
                    SELECT FROM information_schema.columns 
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('properties', '0227_clear_all_0229_migrations'),
