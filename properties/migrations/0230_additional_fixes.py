...
def apply_additional_fixes(apps, schema_editor):
    """Apply additional fixes for Resort table, expiry_date, and data types - SQLite compatible"""
    ...
    with connection.cursor() as cursor:
        # Skip PostgreSQL-specific operations when using SQLite
        if is_sqlite:
            print("Skipping PostgreSQL-specific operations for SQLite")
            return
